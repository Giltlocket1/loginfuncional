    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10">
                        <input type="text" hidden id="id_producto_act"> <!-- ID actualizado a 'id_producto_act' -->
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="edit_cantida" name="edit_cantida" type="text" placeholder="Cantidad">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" id="cantida" name="cantida" type="text" placeholder="Cantidad"> <!-- ID cambiado a 'cantida' -->
